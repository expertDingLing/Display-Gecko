...
// Selectors
// ==================================
export const dashboardTourSelector = createSelector(
  state => state.tour,
  tour => tour.dashboardTourOpen
);
export const configurationTourSelector = createSelector(
  state => state.tour,
  tour => tour.configurationTourOpen
);
export const screenTourSelector = createSelector(
  state => state.tour,
  tour => tour.screenTourOpen
);
...
const ACTION_HANDLERS = {
  ...
  [disableConfigurationTour]: (state, action) => ({
    ...state,
    configurationTourOpen: false
  }),
  [disableScreenTour]: (state, action) => ({
    ...state,
