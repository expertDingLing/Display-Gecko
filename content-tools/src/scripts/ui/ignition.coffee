class ContentTools.IgnitionUI extends ContentTools.WidgetUI
    ...
    mount: () ->
        ...
        @_domElement.setAttribute('id', 'ct-ignition')        
        ...
        @_domEdit.setAttribute('data-tut', 'reactour_screen_edit_button')
        ...
        @_domConfirm.setAttribute('data-tut', 'reactour_screen_confirm_button')
        ...
        @_domCancel.setAttribute('data-tut', 'reactour_screen_cancel_button')
    ...
    _addDOMEventListeners: () ->
        ...
        @_domEdit.addEventListener 'click', (ev) =>
            ...
            document.getElementById("ct-ignition").classList.add('ct-ignition--editing')
        ...
        @_domConfirm.addEventListener 'click', (ev) =>
            ...
            document.getElementById("ct-ignition").classList.remove('ct-ignition--editing')
