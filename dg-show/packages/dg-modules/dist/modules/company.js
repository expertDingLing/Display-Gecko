...
export const companySelector = createSelector(state => state.company, company => company.data); // ==================================
// Actions
// ==================================
...
const ACTION_HANDLERS = {
  [fulfilled(getCompany)]: (state, action) => ({ ...state,
    data: action.payload
  }),
  [fulfilled(updateCompany)]: (state, action) => ({ ...state,
    data: action.payload
  })
}; // ==================================
// Reducer
